...
if __name__ == '__main__':
     ...
     while not rospy.is_shutdown():
          ...
          linearspd = math.sqrt(mrobot_pos_msg.twist.linear.x**2 + mrobot_pos_msg.twist.linear.y**2)
          ...
          spying_data.distance = dis
          spying_data.direction = dir
          spying_data.x = mrobot_pos[0]
          spying_data.y = mrobot_pos[1]
          spying_data.linearspd = linearspd
          spying_data.angularz = mrobot_pos_msg.twist.angular.z
          print('dis: ', dis)
          print('dir: ', dir)
          print('=======================')
